...
from mmcv.runner import (DistSamplerSeedHook, EpochBasedRunner,
                         ...
                         get_dist_info)
from .adv_epoch_based_runner import AdvEpochBasedRunner
from .adv_optimizer import AdvOptimizerHook
from .adv_fp16_optimizer import Fp16AdvOptimizerHook
...
def train_detector(model,
    ...
    if validate:
        ...
        eval_hook = AdvDistEvalHook if distributed else EvalHook
        # In this PR (https://github.com/open-mmlab/mmcv/pull/1193), the
        # priority of IterTimerHook has been modified from 'NORMAL' to 'LOW'.
        runner.register_hook(
            eval_hook(val_dataloader, test_adv_cfg=cfg.get("test_adv_cfg"), **eval_cfg), priority='LOW')
